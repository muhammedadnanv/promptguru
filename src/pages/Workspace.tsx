...
// Helper for responsive classnames
...
const Workspace = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      {/* Navigation */}
      <div className="container mx-auto px-3 xs:px-3 sm:px-4 py-3 flex justify-between items-center">
        ...
        <main className="container mx-auto px-0 xs:px-2 sm:px-4 py-2 md:py-8 max-w-6xl">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-sm xs:text-base md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-2 xs:px-4">
              Transform your ideas into optimized prompts using advanced frameworks and AI models.
            </p>
          </div>
